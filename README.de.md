...
Release Candidates: Konfigurieren → **Release-Kanal** → Staging. Das zeigt auf `http://klar-nlu-staging:10520` oder das neueste GitHub-Prerelease. Stable geht zurück auf `http://klar-nlu:10520`.
