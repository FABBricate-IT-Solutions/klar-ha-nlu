...
Vorschlag, Match / Sprach-Seed / Haus in der Operator-UI zu steuern und den Parse-Pfad zu zeichnen: [ADR 0001](architecture/adr-0001-rules-and-trainer.md) · [Plan](architecture/adr-0001-plan.md).
