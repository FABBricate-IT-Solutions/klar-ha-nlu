...
FAMILY = {
    ...
    "pt-BR": _family("entrada", "salafam", "lavanderia", "lavabo", "quarto", "suitemaster"),
    ...
    "bg": _family("антре", "дневнаfam", "прална", "тоалетна", "спалня", "баняmaster"),
    ...
    "tr": _family("giris", "aile", "camasirhane", "wc", "yatakodasi", "ebatmaster"),
    ...
    "ms": _family("lobi", "ruankeluarga", "dobi", "wc", "bilik", "bilikmandimaster"),
    ...
    "ka": _family("shemosasvleli", "ojakhisotakhi", "samretskhao", "wc", "sadzinebeli", "abazanamaster"),
