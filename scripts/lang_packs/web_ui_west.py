...
engineOffline	Moteur injoignable. La liste reste vide tant qu'un chargement en direct n'a pas réussi.	Engine onbereikbaar. Deze lijst blijft leeg tot een live-lading lukt.	Motor inalcanzable. Esta lista permanece vacía hasta que una carga en vivo tenga éxito.	Motore non raggiungibile. L'elenco resta vuoto finché un caricamento live non riesce.	Motor inacessível. Esta lista fica vazia até um carregamento em direto ter êxito.	Motor inaccessible. Aquesta llista resta buida fins que una càrrega en directe funcioni.	Motorul este inaccesibil. Lista rămâne goală până reușește o încărcare live.	Motor inacessível. Esta lista fica vazia até um carregamento ao vivo ter êxito.	Motor inaccesible. Esta lista queda baleira ata que unha carga en directo teña éxito.
