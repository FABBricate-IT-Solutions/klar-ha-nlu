...
pub struct Nouns {
    ...
    pub calendar_nouns: &'static [&'static str],
...
pub struct Cues {
    ...
    pub calendar_create: &'static [&'static str],
    pub calendar_today: &'static [&'static str],
    pub calendar_tomorrow: &'static [&'static str],
    pub calendar_when: &'static [&'static str],
    pub calendar_delete: &'static [&'static str],
    pub calendar_move: &'static [&'static str],
